...
pub const DEFAULT_WEEKLY_TASKS: &[
    ...
    ("spend_syndicate_standing", "Spend Syndicate Standing If Maxed", "Daily", 0, 1, Some("[\"Syndicate\"]"), None, Some("Base of Operations/Any Relay"), Some("Syndicates"), None, None,),
    ...
    ("dark_sector", "Dark Sector Mission (Double Credit First Mission)", "Daily", 0, 1, Some("[\"Mission\"]"), None, Some("Base of Operations"), Some("Navigation"), None, None,),
    ...
    ("acrithis_daily", "Acrithis Daily Offerings", "Daily", 0, 1, Some("[\"Trade\", \"Vendor\"]"), None, Some("Duviri, Dormizon"), Some("Acrithis"), None, None),
    ("ticker", "Ticker Offerings", "Daily", 0, 1, Some("[\"Trade\", \"Vendor\"]"), None, Some("Fortuna, Venus"), Some("Ticker"), Some("Rising Tide & Command Intrinsics 1"), None),
    ("marie", "Marie Offerings", "Daily", 0, 1, Some("[\"Trade\", \"Vendor\"]"), None, Some(" La Cathédrale (Sanctum Anatomica, Deimos)"), Some("Marie"), Some("The Old Peace"), None),

    // Weekly
    ("nightwave", "Nightwave Challenges", "Weekly", 0, 1, Some("[\"Tasks\"]"), None, None, None, None, None,),
    ...
    ("archon_hunt", "Archon Hunt", "Weekly", 0, 1, Some("[\"Mission\"]"), None, Some("Base of Operations/Dormizone"), Some("Navigation"), Some("The New War"), None,),
    ...
    ("paladino", "Paladino Offerings", "Weekly", 0, 1, Some("[\"Trade\", \"Vendor\"]"), None, Some("Iron Wake, Earth"), Some("Paladino"), Some("The Chains of Harrow"), None),
    ("yonta", "Yonta Offerings", "Weekly", 0, 1, Some("[\"Trade\", \"Vendor\"]"), None, Some("Chrysalith, Zariman"), Some("Yonta"), Some("Angels of the Zariman"), None),
    ("acrithis_weekly", "Acrithis Weekly Offerings", "Daily", 0, 1, Some("[\"Trade\", \"Vendor\"]"), None, Some("Duviri, Dormizon"), Some("Acrithis"), Some("The Duviri Paradox"), None),
    ("teshin", "Teshin Offerings", "Weekly", 0, 1, Some("[\"Trade\", \"Vendor\"]"), None, Some("Any Relay"), Some("Teshin"), Some("Steel Path unlocked"), None),
    ("bird_3", "Bird 3 Offerings", "Weekly", 0, 1, Some("[\"Trade\", \"Vendor\"]"), None, Some("Sanctum Anatomica, Deimos"), Some("Bird 3"), Some("Rank 5 Cavia"), None),
    ("nightcap", "Nightcap Offerings", "Weekly", 0, 1, Some("[\"Trade\", \"Vendor\"]"), None, Some("Fortuna, Venus"), Some("Nightcap"), Some("The New War"), None),
